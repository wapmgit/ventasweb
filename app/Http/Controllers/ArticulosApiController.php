...
class ArticulosApiController extends Controller
{
   ...
   try {	  
			...
			->select ('articulos.idarticulo','articulos.codigo','articulos.nombre','articulos.costo','articulos.precio2 as precio1','articulos.precio3 as precio2','articulos.stock','articulos.imagen')
