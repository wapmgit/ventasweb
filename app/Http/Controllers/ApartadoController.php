 ...
 public function __construct()
	 ...
	 public function index(Request $request)
    {
     ...
     if ($contador==""){$contador=0;}
      return view("apartado.venta.create",["categoria"=>$categoria,"rutas"=>$rutas,"seriales"=>$seriales,"rol"=>$rol,"personas"=>$personas,"articulos"=>$articulos,"monedas"=>$monedas,"contador"=>$contador,"empresa"=>$empresa,"vendedores"=>$vendedor]);
    } else { 
