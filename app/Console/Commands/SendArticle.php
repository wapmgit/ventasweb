...
class SendArticle extends Command
{
    ...
    public function handle()
    {
		...
		$article = DB::table('articulos')->join('categoria as cat','cat.idcategoria','=','articulos.idcategoria')
			->select ('articulos.idarticulo','articulos.codigo','articulos.nombre','articulos.costo','articulos.precio1','articulos.precio2','articulos.precio3','articulos.stock','articulos.imagen','articulos.fraccion','articulos.cntxund','articulos.cntgrupo')
