...
<form action="{{route('multiplecxp')}}" method="GET" enctype="multipart/form-data" >    
	<div class="modal-dialog">
		<div class="modal-content">
			            <div class="modal-header">
              <h4 class="modal-title">Abono Multiple: <?php echo $ndoc=count($datos );?> Documentos  </h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
			<div class="modal-body">
				<h5 align="center">Proveedor: <b>{{$proveedor->cedula}} -> {{$proveedor->nombre}}</b></h5>
			<h3 align="center">Por Pagar: <?php echo number_format($acumn, 2,',','.'); ?> $. </h3>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		       ...
		       <table class="table table-striped table-bordered table-condensed table-hover">                  
					  ...
					  <td><label>Resta: </label><input type="text" name="montop" class="form-control" id="pmontomresta"  value="<?php echo $acumn; ?>" readonly>
					  <input type="hidden" name="pmresta" id="pmresta" value="<?php echo $acumn; ?>" >
					  <input type="hidden" name="pmaux" id="pmaux" value="<?php echo $acumn; ?>" >
					  <input type="hidden" name="cliente" value="{{$proveedor->idproveedor}}" >
