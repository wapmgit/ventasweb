...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<table width="100%"><tr><td width="30%"><strong>Proveedor</strong></td><td width="20%"><strong>Telefono</strong></td><td width="30%"><strong>Direccion</strong></td>
			</tr>
			<tr><td>{{$nota->rif}} -> {{$nota->nombre}}</td><td>{{$nota->telefono}}</td><td>{{$nota->direccion}}</td>
			</tr>
		</table></br>
	</div>
...
<div class ="row">
			...
			<div class="col-12">
                    <div class="form-group" align="center">  
                      <a <?php if ($link==1){?>href="{{route('showcxp',['id'=>$nota->idproveedor])}}"<?Php } else {?>
					  href="{{route('historico',['id'=>$nota->idproveedor])}}" <?php } ?>
					  >
...
$(document).ready(function(){
  ...
  window.print(); 
  <?php  if ($link==1) {?>
  window.location="{{route('showcxp',['id'=>$nota->idproveedor])}}";
  <?php }else{ ?>
  window.location="{{route('historico',['id'=>$nota->idproveedor])}}";
  <?php } ?>
    });
