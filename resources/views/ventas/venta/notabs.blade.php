...
<div id="areaimprimir" >
<div id="margen">
<p id="encabezado" style="display:none"></br></br></br></br></br></br></p>
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<table width="100%" BORDER="0">
	<tr><td><small><b>FACTURA N° : </small>*</b><?php if($empresa->usaserie==1){ echo "Serie".$empresa->serie; } ?><?php  $idv=$venta->idventa; echo add_ceros($idv,$ceros); ?></td><td><td><small><b>FECHA DE EMISION: </small></b><?php echo date("d-m-Y",strtotime($venta->fecha_emi)); ?></td><td><small><b>CONDICION: </small></b>{{$venta->estado}}</td></tr>
