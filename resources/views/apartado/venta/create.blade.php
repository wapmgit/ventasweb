   ...
   @foreach ($contador as $p)
	...
	<div class="row" style="background-color:#f3f4f4"> 
		<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
			...
			<input type="hidden" value="0" id="usafl" ></input>
			<input type="hidden" value="{{$empresa->nlineas}}" id="nlineas" ></input>
			<input type="hidden" value="0" id="faccredito" ></input>
        </div>
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
            ...
            <div class="row" style="background-color:#edefef">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                    	...
                    	<select name="id_cliente" id="id_cliente" class="form-control selectpicker" data-live-search="true">						
                           ...
                           <option value="{{$per -> id_cliente}}_{{$per -> tipo_precio}}_{{$per -> comision}}_{{$per -> nombrev}}_{{0}}">{{$per -> cedula}}-{{$per -> nombre}}</option> 
                           @endforeach
                        </select>
				...
				<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<table><tr><td>	<div class="form-group">
						<label for="serie_comprobante">Dias Apartado</label>
							<input type="date" style="display: none" name="fecha_emi" <?php if ($nivel=="L"){?> readonly <?php }  ?>  id="fecha_emi" value="<?php echo $fserver;?>" class="form-control control-sm">
							<input type="hidden" name="tipo_comprobante" class="form-control" value="APA">
							<input type="number" name="dias" class="form-control" value="60">
						</div></td><td><div class="form-group">
							<label for="serie_comprobante">% adicional</label>
							...
							<input type="text" style="display: none" style="background-color:#edefef" name="control" value="00-" size="8" class="form-control" placeholder="Num de Control" > 
						<input type="number" name="incremento" class="form-control" value="5">
						</div>	</td><td>	<div class="form-group">
			...
			<div class ="row" id="divdesglose" style="display: none">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-lg-4 ol-md-4 col-sm-6 col-xs-6"  align="left" id="formato">
						...
						<option value="0" selected="selected">Formato Por Defecto</option>
						<option  value="1">Diseño Ticket</option>				
						</select>						
								</div>
