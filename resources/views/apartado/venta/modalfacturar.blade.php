...
role="dialog" tabindex="-1" id="modalfacturar-{{$venta->idventa}}">
<form action="{{route('facapartado')}}" id="forimportar" method="POST" enctype="multipart/form-data" >         
        {{csrf_field()}}
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="row">
				...
				<p>Confirma Convertir en factura el  Apartado {{$venta->idventa}}?</p>
				</div>
...
<div class="form-group">
			...
			<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			           <div class="form-group">
							<input type="hidden" value="<?php echo $venta->texe; ?>" name="texe" >
						  <input type="hidden" value="<?php echo $venta->total_iva; ?>" name="total_iva" >
						  <input type="hidden" value="<?php echo $venta->base; ?>" name="total_base" >
