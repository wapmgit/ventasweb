...
?>
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Ajuste a partir de Archivo csv</h3>
        </div>

    </div>
	<form action="{{route('guardaajuste')}}" method="post" id="formajustecsv" enctype="multipart/form-data" >         
		{{csrf_field()}} 	
    <div class="row">
                    ...
                    <div class="table-responsive">
						<table  class="table table-striped table-bordered table-condensed table-hover">
							...
							<th>Total</th>
							  ...
							  <th></th>
							  <th></th>
							  <th><h4 id="total"><?php echo "$". number_format($acumst,'2','.','.');?></h4><input type="text" class ="form-control" name="totalo" id="totalo" value="<?php echo $acumst; ?>"></th>
							</tfoot>
						</table>
					</div>
                </div>
