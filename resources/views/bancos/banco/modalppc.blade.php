...
role="dialog" tabindex="-1" id="modalppc">
	{!!Form::open(array('url'=>'/bancos/rubro','method'=>'POST','autocomplete'=>'off','id'=>'formulariocliente','files'=>'true'))!!}
 {{Form::token()}}
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
                ...
                <h4 class="modal-title">Registro de credito especial a terceros</h4>
			</div>
			<div class="modal-body">
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
										  <div class="form-group">
										<label for="saco">Rubro</label>
				                        <select name="rubro"  class="form-control selectpicker" data-live-search="true">
				                      @foreach ($rubro as $ru)
				                              <option value="{{$ru->idarticulo}}">{{$ru->codigo}} - {{$ru->nombre}}</option> 
				                              @endforeach
				                              </select>
										</div>
									</div>	
										<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
										  <div class="form-group">
										<label for="saco">KG neto</label>
				                	<input type="number" name="kg"  value="0" step="0.01" class="form-control" placeholder="kg...">
										</div>
									</div>
									<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
										 <div class="form-group">
											    <label for="concepto">Observacion</label>
											<input type="text" name="concepto"  value="" class="form-control" placeholder="observacion...">
										</div>
									</div>
						<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
										 <div class="form-group">
