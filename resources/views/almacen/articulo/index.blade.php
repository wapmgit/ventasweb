			...
			<table id="articulostable" class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($articulos as $cat)
				<tr>
					...
					@if($empresa->mp2==1)<td><small><?php echo number_format(($cat->precio2), 2,',','.'); ?></small></td>@endif
					@if($empresa->mp3==1)<td><small><?php echo number_format(($cat->precio3), 2,',','.'); ?></small></td>@endif
					<td>																		                                         
				<div class="btn-group">
