...
<div class="row" id="body">
    ...
    <div class="price-tag">
        <div class="company-info">
            <p class="date-info"> {{ $articulo->codigo }}</p> 
        </div>
        ...
        <div class="footer">
            <div class="barcode-section">            
                <div class="barcode-visual">
                   <div>
					<img src="https://bwipjs-api.metafloor.com/?bcid=code128&text={{ $articulo->codigo }}&scale=1&rotate=N&includetext" alt="Barcode">
					</div> 
                </div>
            </div>
