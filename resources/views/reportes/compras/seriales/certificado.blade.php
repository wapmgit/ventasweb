...
.fuente{
   ...
   <?php echo espaciostab(1).espacios(4)."&nbsp;"; ?><font  class="fuentet">{{ $cliente->nombre}} </font></br></br>
	...
	<?php echo espaciostab(3).espacios(1)."&nbsp;"; ?><font  class="fuentet">{{ $cliente->codpostal}} </font></br></br></br>
	<?php echo espaciostab(3).espacios(6)."&nbsp;"; ?><font  class="fuente"><sub>{{ $cliente->telefono}} </sub></font></br>
   </br>		</br> 
		</br>   </br>
		</br>    </br>
