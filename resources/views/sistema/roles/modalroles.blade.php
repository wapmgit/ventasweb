		...
		<div class="modal-content">
            ...
            <div class="card card-primary card-tabs">
              ...
              <div class="card-body">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
					 <div class="form-group">
					 <label>Carga Rapida (Ventas): </label><label>
					  <input type="checkbox" name="op77" class="minimal" @if($q->cargarapida==1) checked @endif ></label>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
					 <div class="form-group">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
					 <div class="form-group">
					 <label>Crear Ajuste(Entrada): </label><label>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-one-messages{{$q->id}}" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab{{$q->id}}">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<div class="form-group">
						<label>Reporte Revision Pedidos: </label><label>
						<input type="checkbox" name="op79" class="minimal" @if($q->revisionpedido==1) checked @endif ></label>
						</div>
						</div>
						</div>
                  </div>
