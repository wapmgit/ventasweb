...
Route::get('etiquetarticulo/{id}', [ArticulosController::class, 'etiquetarticulo'])->name('etiquetarticulo');
...
Route::get('reportecxpvencida', [ReportescomprasController::class, 'reportecxpvencida'])->name('reportecxpvencida');
...
Route::get('catalogo.pdf', [ReportesarticulosController::class, 'descargarPdf'])->name('catalogo.pdf');
//banco
...
Route::post('newuser', [SistemaController::class, 'newuser'])->name('newuser');
