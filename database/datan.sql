...
DROP TABLE IF EXISTS `cxcclientes`;
...
DROP TABLE IF EXISTS `kardexrepetido`;
...
DROP TABLE IF EXISTS `kardexrepetido_soloventas`;
...
DROP TABLE IF EXISTS `kardex_updatestock`;
